...
def main(list_employers, new_database, word) -> None:
    ...
    try:
        ...
        example_1.get_companies_and_vacancies_count()
        example_1.get_all_vacancies()
        example_1.get_avg_salary()
        example_1.get_vacancies_with_higher_salary()
        example_1.get_vacancies_with_keyword(word)
...
if __name__ == '__main__':
    ...
    main(list_employers_, new_database='my_db', word='авиалинии')